...
function HeroSection() {
  ...
  return (
    <HeroSectionContainer className="OuterContent hero-section">
      ...
      <RecruiteeHeader className="ml-2 my-auto">
        <Hero3DBackground />
        <RecruiteeHeadline className="recruitee-name neomorph">
          Bruno Costa
        </RecruiteeHeadline>
        <RecruiteeSubHeadline className="recruitee-headline neomorph">
          Frontend Developer
        </RecruiteeSubHeadline>
      </RecruiteeHeader>
      <button
        onClick={() => scrollToClassName(".summary-section")}
        className="next-section-arrow-button flex justify-center"
      >
        <ScrollDownArrowSvg
          width="20px"
          height="20px"
